...
val day15 = project.in(file("Day15")).settings(commonSettings: _*)
val day16 = project.in(file("Day16")).settings(commonSettings: _*)
val day17 = project.in(file("Day17")).settings(commonSettings: _*)
val day18 = project.in(file("Day18")).settings(commonSettings: _*)
val day19 = project.in(file("Day19")).settings(commonSettings: _*)
val day20 = project.in(file("Day20")).settings(commonSettings: _*)
val day23 = project.in(file("Day23")).settings(commonSettings: _*)
val day25 = project.in(file("Day25")).settings(commonSettings: _*)
